...
function list () {
  return _.cloneDeep(data); //so if people filter through, they don't mess with original array
}

function find (properties) {
  return _.cloneDeep(_.filter(data, properties)); //filtered to make sure they have these things
}
